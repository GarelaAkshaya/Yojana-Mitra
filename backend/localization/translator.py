...
CATALOG = {
    "en": {
        ...
        "welcome_body": "Select a page from the sidebar to get started.",
        ...
        "send": "Send",
        "recorded": "Audio recorded. Send it to ask this question.",
    ...
    "hi": {
        ...
        "welcome_body": "शुरू करने के लिए साइडबार से कोई पेज चुनें.",
        ...
        "send": "भेजें",
        "recorded": "ऑडियो रिकॉर्ड हो गया. प्रश्न पूछने के लिए भेजें.",
    ...
    "te": {
        ...
        "welcome_body": "ప్రారంభించడానికి సైడ్‌బార్‌లో పేజీని ఎంచుకోండి.",
        "settings_title": "సెట్టింగ్స్",
        "language": "భాష",
        "choose_language": "మీకు కావాల్సిన భాషను ఎంచుకోండి",
        ...
        "send": "పంపండి",
        "recorded": "ఆడియో రికార్డ్ అయింది. ప్రశ్న అడగడానికి పంపండి.",
